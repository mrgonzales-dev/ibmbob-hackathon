...
| Skill | What it does |
|---|---|
| `bob-upgrade-check` | Major framework upgrade risk analyzer. Scans a project for the package, code, and config changes a version bump causes. Returns one ranked HIGH/MED/LOW report and an optional phased plan. |
